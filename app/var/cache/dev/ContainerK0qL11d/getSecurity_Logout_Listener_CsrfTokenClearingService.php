 ...
 */
class getSecurity_Logout_Listener_CsrfTokenClearingService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-http/EventListener/CsrfTokenClearingLogoutListener.php';
