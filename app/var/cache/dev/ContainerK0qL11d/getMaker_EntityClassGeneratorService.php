 ...
 */
class getMaker_EntityClassGeneratorService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/maker-bundle/src/Doctrine/EntityClassGenerator.php';
