 ...
 */
class getDebug_Security_Voter_VoteListenerService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-bundle/EventListener/VoteListener.php';
