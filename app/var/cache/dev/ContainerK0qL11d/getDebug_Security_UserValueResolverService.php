 ...
 */
class getDebug_Security_UserValueResolverService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-http/Controller/UserValueResolver.php';
