 ...
 */
class getSecurity_Command_UserPasswordHashService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/password-hasher/Command/UserPasswordHashCommand.php';
