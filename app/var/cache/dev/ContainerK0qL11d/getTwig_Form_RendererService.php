 ...
 */
class getTwig_Form_RendererService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/form/FormRendererInterface.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/form/FormRenderer.php';
