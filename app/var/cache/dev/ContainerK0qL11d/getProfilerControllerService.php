 ...
 */
class getProfilerControllerService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/doctrine/doctrine-bundle/src/Controller/ProfilerController.php';
