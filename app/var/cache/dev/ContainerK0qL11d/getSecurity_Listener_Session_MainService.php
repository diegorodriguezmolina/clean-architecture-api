 ...
 */
class getSecurity_Listener_Session_MainService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-http/EventListener/SessionStrategyListener.php';
