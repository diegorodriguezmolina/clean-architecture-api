 ...
 */
class getTurbo_Doctrine_EventListenerService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/ux-turbo/src/Doctrine/BroadcastListener.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/ux-turbo/src/Broadcaster/BroadcasterInterface.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/ux-turbo/src/Broadcaster/TwigBroadcaster.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/ux-turbo/src/Broadcaster/ImuxBroadcaster.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/ux-turbo/src/Broadcaster/IdAccessor.php';
