 ...
 */
class getSecurity_AccessListenerService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-http/Firewall/AccessListener.php';
