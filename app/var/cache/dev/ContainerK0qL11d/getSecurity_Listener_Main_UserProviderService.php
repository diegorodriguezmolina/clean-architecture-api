 ...
 */
class getSecurity_Listener_Main_UserProviderService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-http/EventListener/UserProviderListener.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-core/User/UserProviderInterface.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-core/User/InMemoryUserProvider.php';
