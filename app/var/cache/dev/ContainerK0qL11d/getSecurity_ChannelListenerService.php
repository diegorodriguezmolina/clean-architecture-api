 ...
 */
class getSecurity_ChannelListenerService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-http/Firewall/ChannelListener.php';
