 ...
 */
class getWebProfiler_Controller_RouterService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/web-profiler-bundle/Controller/RouterController.php';
