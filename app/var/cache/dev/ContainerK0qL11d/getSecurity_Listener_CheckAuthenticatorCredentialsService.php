 ...
 */
class getSecurity_Listener_CheckAuthenticatorCredentialsService extends FitnessApi_App_AppKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/security-http/EventListener/CheckCredentialsListener.php';
